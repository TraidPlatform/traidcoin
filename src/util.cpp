...
int nAnonymizeTraidAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Traid
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Traid
    // Mac: ~/Library/Application Support/Traid
    // Unix: ~/.Traid
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Traid";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Traid.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Traidd.pid"));
