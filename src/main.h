...
#define START_MASTERNODE_PAYMENTS_TESTNET 1523969172 //
#define START_MASTERNODE_PAYMENTS 1524153600 // 

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);// 
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 TRAID per block has been ignored
static const int64_t TARGET_SPACING = 2 * 60; // 2 min per Block
//static const int64_t TARGET_SPACING2 = 53; // 53 sec per Block
//static const int64_t STAKE_TIMESPAN_SWITCH_TIME = 1531751570;
//static const int64_t STAKE_TIMESPAN_SWITCH_TIME1 = 1531751570; //
//static const int64_t FORK_TIME = 1531751570;  //
...
static const int64_t MAX_MONEY = 252000000 * COIN; // 252M coins
...
inline int64_t GetMNCollateral(int nHeight) { return 60000; }
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees, int64_t nTime);
